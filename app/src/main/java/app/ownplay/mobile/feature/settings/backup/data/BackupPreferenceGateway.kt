...
internal class BackupPreferenceGateway(
    ...
    suspend fun apply(
        ...
        check(displayRepository.setShowCategoryFlags(globalSettings.display.showCategoryFlags))
        check(displayRepository.setHideLiveCategoryPrefix(globalSettings.display.hideLiveCategoryPrefix))
        check(displayRepository.setHideLibraryCategoryPrefix(globalSettings.display.hideLibraryCategoryPrefix))
    ...
    suspend fun restore(snapshot: BackupPreferenceSnapshot) {
        ...
        check(displayRepository.setShowCategoryFlags(snapshot.globalSettings.display.showCategoryFlags))
        check(displayRepository.setHideLiveCategoryPrefix(snapshot.globalSettings.display.hideLiveCategoryPrefix))
        check(displayRepository.setHideLibraryCategoryPrefix(snapshot.globalSettings.display.hideLibraryCategoryPrefix))
