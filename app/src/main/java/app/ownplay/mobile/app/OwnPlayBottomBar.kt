        ...
        AppDestination.primaryEntries.forEach { destination ->
            ...
            NavigationBarItem(
                ...
                colors = NavigationBarItemDefaults.colors(
                    selectedIconColor = OwnPlayColors.Accent,
                    selectedTextColor = OwnPlayColors.Accent,
                    indicatorColor = OwnPlayColors.SurfaceRaised,
                    unselectedIconColor = OwnPlayColors.TextMuted,
                    unselectedTextColor = OwnPlayColors.TextSecondary,
                ),
                icon = {
                    Icon(
